<head>
    ...
    <link href="../../../css?family=Montserrat:300,400,500,600" rel="stylesheet">
    ...
    <title>@yield('title', 'Dashboard analytics - Vuexy - Bootstrap HTML admin template')</title>
